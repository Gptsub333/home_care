...
//   // In your provider profile page component
// const [reviews, setReviews] = useState([]);
// const [reviewsLoading, setReviewsLoading] = useState(false);
// const [reviewsPagination, setReviewsPagination] = useState(null);
// const [currentPage, setCurrentPage] = useState(1);

// // Fetch reviews separately from provider details
// useEffect(() => {
...
// // Function to refresh reviews after submitting
// const refreshReviews = () => {
//   setCurrentPage(1); // Reset to first page
//   // The useEffect will automatically refetch
// };

// // Update handleSubmitReview to refresh reviews after submission
...
// //     // Refresh the provider data to show the new review
// //     setProvider();
// //   } catch (err) {
// //     console.error(err);
// //     alert(err.message || "Something went wrong while submitting your review.");
