...
const mockProvider = {
  ...
  reviews: [
    ...
    },
    {
      ...
      rating: 4,
      date: "2 months ago",
      comment: "Great experience overall. Dr. Johnson is knowledgeable and friendly. Would definitely book again.",
    },
  ],
}
...
export default function ProviderProfilePage() {
  ...
  const handleBooking = () => {
    console.log("[v0] Booking:", { date, selectedTime, selectedService, notes })
  ...
  const selectedServiceDetails = mockProvider.services.find((s) => s.name === selectedService)
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <Link href="/login">
                <Button variant="outline" size="sm" className="border-teal-200 hover:bg-teal-50 bg-transparent">
                  Sign In
                </Button>
              </Link>
            </nav>
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                      <div>
                        ...
                        <p className="text-lg text-muted-foreground mb-3">{mockProvider.specialty}</p>
                ...
                <Card className="border-teal-100 shadow-lg">
                  <CardContent className="p-6 space-y-6">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">{mockProvider.about}</p>
                    </div>
                    <div>
                      <h3 className="text-xl font-semibold mb-3 text-teal-700">Education & Credentials</h3>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-6">
                      {mockProvider.reviews.map((review) => (
                        <div key={review.id} className="border-b border-teal-100 last:border-0 pb-6 last:pb-0">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <div className="flex items-center gap-1">
                              {Array.from({ length: review.rating }).map((_, i) => (
                                <StarIcon key={i} className="h-4 w-4 text-yellow-400" filled />
                              ))}
                            </div>
                          </div>
                ...
                <Dialog open={isBookingOpen} onOpenChange={setIsBookingOpen}>
                  ...
                  <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                      ...
                      <DialogDescription>Schedule your visit with {mockProvider.name}</DialogDescription>
                    </DialogHeader>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          {timeSlots.map((time) => (
                            <Button
                              ...
                              className={selectedTime === time ? "bg-gradient-to-r from-teal-500 to-blue-500" : ""}
                            >
                              {time}
                            </Button>
                          ))}
